...
| --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| Font Color                                    | RED for MR changes on Hydro space<br>Black on Telco space                                                          | RED for MR changes on Hydro space<br>Black on Telco space               | Only Black                                                                                        |
| Primary wires                                 | All wires are drawn                                                                                                | Lowest primary height is drawn                                          | All wires are drawn                                                                               |
| Primary wires with MR                         | '**PRIM.**' will be in Bold, Red,<br>**Original height** in Bold, Red<br>then **MR height** in '**()**' ,Bold, Red | 'PRIM.' in Red<br>Original height in Red<br>then MR height in '()', Red | '**PRIM.**' will be in Bold,<br>Original height in '()', Black<br>**MR height** in Bold, Black    |
| Neutral/Sec wire                              | All wires are drawn                                                                                                | All wires are drawn                                                     | All wires are drawn                                                                               |
| Neutral/Sec wire with MR                      | '**NEUT./SEC.**' in Bold, Red<br>**Original height** in Bold, Red<br>**MR height** in '**()**', Bold, Red          | 'NEUT./SEC.' in Red<br>Original height in Red<br>MR height in '()', Red | '**NEUT./SEC.**' in Bold, Black<br>Original height in '()', Black<br>**MR height** in Bold, Black |
| Proposed guys with<br>Proposed Telco wire     | '**P.BELL/ P.D.G.**' in Bold                                                                                       | '**P.BELL/ P.D.G.**' in Bold                                            | '**P.XCI/ D.G.**' in Bold                                                                         |
| Feature in new heights<br>and Original height | Original height in normal<br>New height in '()' in normal                                                  		 | Original height in normal<br>New height in '()' in normal       		   | Original height in '()'<br>**New height** in Bold<br>	                                           |
