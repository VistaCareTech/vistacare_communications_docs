# Map SharePoint as a Windows Network Drive
...
9. If all the previous steps were performed correctly, the new mapped Network Drive should appear with the chosen Drive letter.
